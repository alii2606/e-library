...
const publisher_resolver_1 = require("./publisher.resolver");
...
exports.PublisherModule = PublisherModule = __decorate([
    (0, common_1.Module)({
        providers: [publisher_resolver_1.PublisherResolver, publisher_service_1.PublisherService, prisma_service_1.PrismaService],
    })
], PublisherModule);
